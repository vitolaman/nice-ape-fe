import { useTokenInfo, useTokenInfoCampaign } from '@/hooks/queries';
...
export const BondingCurve2: React.FC<BondingCurveProps> = ({ className, id }) => {
  const { data: bondingCurve } = useTokenInfoCampaign(id as string, (data) => data?.bondingCurve);
